module github.com/omertuc/assisted-swarm
...
require (
	...
	github.com/openshift/assisted-installer-agent v1.0.10-0.20220424162245-897f8b322bf8
...
require (
	...
	github.com/openshift/baremetal-runtimecfg v0.0.0-20220211165258-fe92b9507bec // indirect
	github.com/openshift/client-go v0.0.0-20220302123837-25b55b99bd24 // indirect
	...
	github.com/openshift/machine-api-operator v0.2.1-0.20201002104344-6abfb5440597 // indirect
	github.com/operator-framework/api v0.14.0 // indirect
	github.com/operator-framework/operator-lifecycle-manager v0.18.0 // indirect
...
require (
	...
	github.com/openshift/assisted-installer v1.0.10-0.20220422142219-912c3b26e4f1
...
replace (
	...
	github.com/openshift/assisted-service/api v0.0.0 => github.com/openshift/assisted-service/api v1.0.10-0.20220417143302-42b015ea6262
	github.com/openshift/assisted-service/models v0.0.0 => github.com/openshift/assisted-service/models v0.0.0-20220417143302-42b015ea6262
